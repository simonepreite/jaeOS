...
pid_t genPid(){
	...
	// TODO: implementare generazione PID
	/* Si usa count come valore sequenziale insieme all'indirizzo del processo, o cose simili; va gestita il caso quando count raggiunge il valore massimo e si deve ripartire da 0, skippando i pid ancora esistenti */
}
